...
- [x] **UI-01**: Skill `agent-ui` — interface de agente
- [x] **UI-02**: Skill `chat-ui` — interface de chat
- [x] **UI-03**: Skill `tools-ui` — interface de ferramentas
- [x] **UI-04**: Skill `widgets-ui` — widgets de interface
